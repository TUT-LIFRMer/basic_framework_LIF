 ...
 */
 ...
 typedef enum
 {
     ...
     //ID_supply_projectile_action = 0x0102,   场地补给站动作标识数据 2025.3.14删除，2024.12.25 V1.7.0 删除该命令码
     //ID_supply_projectile_booking = 0x0103,  场地补给站预约子弹数据 2025.3.14删除，在裁判系统串口协议附录中未找到
     ID_referee_warning = 0x0104,              // 裁判系统警告数据 2025.3.14添加
     ID_dart_info = 0x0105,				   // 飞镖发射数据 2025.3.14添加
     ID_game_robot_state = 0x0201,		   // 机器人状态数据
     ID_power_heat_data = 0x0202,		   // 实时缓冲热量数据
     ID_game_robot_pos = 0x0203,			   // 机器人位置数据
     ID_buff_musk = 0x0204,				   // 机器人增益数据
     //ID_aerial_robot_energy = 0x0205,	    空中机器人能量状态数据 2025.3.14删除，2024.12.25 V1.7.0 删除该命令码
     ID_robot_hurt = 0x0206,				   // 伤害状态数据
     ID_shoot_data = 0x0207,				   // 实时射击数据
     ID_shoot_num = 0x0208,				   // 发弹量数据
 } CmdID_e;
 ...
 /* ID: 0x0105  Byte:  3    飞镖发射数据 2025.3.14添加*/
 typedef  struct 
{ 
...
{ 
 ...
 /* ID: 0x0205  Byte:  2    空中机器人能量状态数据 2025.3.14删除，2024.12.25 V1.7.0 删除该命令码
 typedef struct
 {
